...
struct ScatterDotStyle {
    ...
    // 透明度范围
    static let minOpacity: Double = 0.3              // 最小透明度（弱色偏）
    static let maxOpacity: Double = 1.0              // 最大透明度（强色偏）
...
struct SinglePolarScatter: View {
    ...
    private func scatterDot(point: ColorCastPoint) -> some View {
        ...
        // 透明度随 strength 变化
        let opacityMultiplier = ScatterDotStyle.minOpacity + (ScatterDotStyle.maxOpacity - ScatterDotStyle.minOpacity) * Double(strength)
        ...
        return ZStack {
            ...
            Circle()
                ...
                .opacity(ScatterDotStyle.halo3Opacity * opacityMultiplier)
                .blendMode(.multiply)
            ...
            Circle()
                ...
                .opacity(ScatterDotStyle.halo2Opacity * opacityMultiplier)
                .blendMode(.multiply)
            ...
            Circle()
                ...
                .opacity(ScatterDotStyle.halo1Opacity * opacityMultiplier)
                .blendMode(.multiply)
