...
class ColorAnalysisEvaluator {
    ...
    你关注的不是照片背后的意义、动机或态度，而是图像呈现出来的气质本身：色彩的倾向、光线的触感、画面流动的节奏、构图的习惯、空间的疏密关系、主体被放置的位置与方向、注意力被吸引的对象，以及作品讲述的故事和自然浮现的情绪氛围。
    ...
    语言保持柔软、节制、清澈、有灵气，让评论像一段安静的阅读，而非解读或诠释。整体语气像是在对人说话，而不是写作。
